...
This privacy policy describes how **OpenBudget** (“the app”) handles your information. The app is designed with a **local-first** approach: your budget data is stored on your device first. Optional iCloud sync is described below.
